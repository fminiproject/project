function save_yes(){
	...
	}else if(typeof frm.join_point.value != 'number'){
		alert("숫자만 입력해주세요.");
	}else if(frm.join_lv.value == ""){
		alert("회원가입 시 권한레벨을 입력해주세요.");
	}else if(typeof frm.join_lv.value != 'number'){
		alert("숫자만 입력해주세요.");

...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../common/css/login.css?v=11">
    <link rel="stylesheet" type="text/css" href="../common/css/main.css?v=11">
    <link rel="stylesheet" type="text/css" href="../common/css/notice.css?v=11">
